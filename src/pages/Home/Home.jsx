...
function ConnectLink({ href, label, children }) {
  const ref = useRef(null)
  useMagnetic(ref, { strength: 0.18, radius: 45 })
  return (
    <a ref={ref} href={href} className={styles.connectButton} target="_blank" rel="noopener noreferrer">
      <div className={styles.connectLogo}>{children}</div>
      <div className={styles.connectText}>{label}</div>
    </a>
  )
}
      ...
      >
          ...
          <div className={styles.container}>
            <div className={styles.hero}>
              ...
              <p className={styles.heroSubtitle}>
                {t.heroSubtitle.split('{word}')[0]}<WordCycle />{t.heroSubtitle.split('{word}')[1]}
              </p>
        ...
        >
          <div className={`${styles.container} ${styles.connectContainer}`}>
            ...
            <ConnectLink href="https://www.linkedin.com/in/weston-guo/" label="LinkedIn">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" fill="currentColor" />
              </svg>
            </ConnectLink>
            <ConnectLink href="mailto:westongu@usc.edu" label="Email">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" fill="currentColor" />
              </svg>
            </ConnectLink>
            <ConnectLink href="https://github.com/west0nG" label="GitHub">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <ConnectLink href="https://okjk.co/hS2gAU" label="Jike">
