      ...
      >
        ...
        >
          <div className={`${styles.container} ${styles.connectContainer}`}>
            ...
            <a href="https://www.linkedin.com/in/weston-guo/" className={styles.connectButton} target="_blank" rel="noopener noreferrer">
            ...
            <a href="mailto:westongu@usc.edu" className={styles.connectButton} target="_blank" rel="noopener noreferrer">
              <div className={styles.connectLogo}>
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://github.com/west0nG" className={styles.connectButton} target="_blank" rel="noopener noreferrer">
              <div className={styles.connectLogo}>
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://okjk.co/hS2gAU" className={styles.connectButton} target="_blank" rel="noopener noreferrer">
              <div className={styles.connectLogo}>
